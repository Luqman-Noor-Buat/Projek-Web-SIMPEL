...
if(strlen($id) == 10){
    ...
    //kegiatan
    $sql1 = "SELECT * FROM kegiatan WHERE ID_KEGIATAN='$id'";
                            ...
                            <div class="breadcrumb-wrapper mb-30">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a href="program.php?id=<?=$id?>">Program</a> 
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-style mb-30">
                                <a href="program.php?id=<?=$id?>" class="mb-4"><i class="lni lni-chevron-left"></i>Kembali</a>
                                        ...
                                        <tbody>
                                            <?php while($row = mysqli_fetch_array($hasil)) : ?>
                                                <tr>
                                                    <td>
                                                        <p>
                                                            <a href="subkegiatan.php?id=<?=$row['ID_KEGIATAN']?>"><?=  $row["ID_KEGIATAN"], " ", $row["KEGIATAN"]; ?></a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
