...
if(strlen($id) == 1){
    //program
    $sql = "SELECT * FROM bidang WHERE ID_URUSAN='$id'";
    $hasil = mysqli_query($conn, $sql);
}else{
    //program
    $sql1 = "SELECT * FROM bidang WHERE ID_BIDANG='$id'";
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-style mb-30">
                                <a href="rencana.php" class="mb-4"><i class="lni lni-chevron-left"></i>Kembali</a>
                                        ...
                                        <tbody>
                                            <?php while($row = mysqli_fetch_array($hasil)) : ?>
                                                <tr>
                                                    <td>
                                                        <p>
                                                            <a href="skpd.php?id=<?=$row['ID_BIDANG']?>"><?=  $row["ID_BIDANG"], " ", $row["BIDANG"]; ?></a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
