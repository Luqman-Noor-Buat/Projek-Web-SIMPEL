...
$sql = "SELECT 
        ...
        WHERE transaksi.ID_TEMA = $id_tema AND transaksi.TRIWULAN = '$triwulan';";
...
$sheet->setCellValue('I1', "Laporan Rencana Tema : $tema");
...
$sheet->setTitle("Laporan Rencana");
// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Rencana.xlsx"'); // Set nama file excel nya
