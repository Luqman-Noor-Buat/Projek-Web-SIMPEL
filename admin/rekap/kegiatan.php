...
if(strlen($id) == 11){
    ...
    //kegiatan
    $sql = "SELECT * FROM kegiatan WHERE ID_PROGRAM='$id_program'";
    $hasil = mysqli_query($conn, $sql);
    $sql5 = "SELECT SUM(ANGGARAN_TEMA_PERSUBKEGIATAN) AS Total_Anggaran_pertema FROM transaksi WHERE ID_PROGRAM = '$id_program' AND ID_TEMA = $id_tema";
    $hasil5 = mysqli_query($conn, $sql5);
    $row5 = mysqli_fetch_array($hasil5);
    $sql7 = "SELECT SUM(REALISASI_ANGGARAN) AS Total_Realisasi FROM transaksi WHERE ID_PROGRAM = '$id_program' AND ID_TEMA = $id_tema";
    $hasil7 = mysqli_query($conn, $sql7);
    $row7 = mysqli_fetch_array($hasil7);
    $sql8 = "SELECT (SUM(ANGGARAN_TEMA_PERSUBKEGIATAN))-(SUM(REALISASI_ANGGARAN)) AS Sisa_Anggaran FROM transaksi WHERE ID_PROGRAM = '$id_program' AND ID_TEMA = $id_tema";
    $hasil8 = mysqli_query($conn, $sql8);
    $row8 = mysqli_fetch_array($hasil8);
    $sql9 = "SELECT KECAMATAN, DESA FROM transaksi WHERE ID_PROGRAM = '$id_program'";
    $hasil9 = mysqli_query($conn, $sql9);
    $hasil9_1 = mysqli_query($conn, $sql9);
    
}else{
    $id_kegiatan = substr($id,0,13);
    $id_tem = substr($id,-1);
    $id_tema = intval($id_tem);
    //program
    $sql1 = "SELECT * FROM kegiatan WHERE ID_KEGIATAN='$id_kegiatan'";
    $hasil1 = mysqli_query($conn, $sql1);
    $row1 = mysqli_fetch_array($hasil1);
    $id = $row1['ID_PROGRAM'];
    $sql = "SELECT * FROM kegiatan WHERE ID_PROGRAM='$id'";
    $hasil = mysqli_query($conn, $sql);
    $sql5 = "SELECT SUM(ANGGARAN_TEMA_PERSUBKEGIATAN) AS Total_Anggaran_pertema FROM transaksi WHERE ID_PROGRAM = '$id' AND ID_TEMA = $id_tema";
    $hasil5 = mysqli_query($conn, $sql5);
    $row5 = mysqli_fetch_array($hasil5);
    $sql7 = "SELECT SUM(REALISASI_ANGGARAN) AS Total_Realisasi FROM transaksi WHERE ID_PROGRAM = '$id' AND ID_TEMA = $id_tema";
    $hasil7 = mysqli_query($conn, $sql7);
    $row7 = mysqli_fetch_array($hasil7);
    $sql8 = "SELECT (SUM(ANGGARAN_TEMA_PERSUBKEGIATAN))-(SUM(REALISASI_ANGGARAN)) AS Sisa_Anggaran FROM transaksi WHERE ID_PROGRAM = '$id' AND ID_TEMA = $id_tema";
    $hasil8 = mysqli_query($conn, $sql8);
    $row8 = mysqli_fetch_array($hasil8);
    $sql9 = "SELECT KECAMATAN, DESA FROM transaksi WHERE ID_PROGRAM = '$id' AND ID_TEMA = $id_tema";
    $hasil9 = mysqli_query($conn, $sql9);
    $hasil9_1 = mysqli_query($conn, $sql9);
}
                            ...
                            <div class="breadcrumb-wrapper mb-30">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item ">
                                            <a href="program.php?id=<?=$id,$id_tema?>">Program</a> 
                                        </li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-style mb-30">
                                <a href="program.php?id=<?=$id,$id_tema?>" class="mb-4"><i class="lni lni-chevron-left"></i>Kembali</a>
                                        ...
                                        <tbody>
                                            <?php while($row = mysqli_fetch_array($hasil)) : ?>
                                                <tr>
                                                    <td>                                                       
                                                        <p>
                                                            <a href="subkegiatan.php?id=<?=$row['ID_KEGIATAN'],$id_tema?>"><?=$row['ID_KEGIATAN']," ",$row['KEGIATAN']?></a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            <?php endwhile;  ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            Total Realisasi Anggaran Perprogram
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <strong>Sisa Anggaran Perprogram</strong>
                                                        </td>
                                                        <td>
